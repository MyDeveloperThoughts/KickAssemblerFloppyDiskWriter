...
// 1541 https://vice-emu.sourceforge.io/vice_17.html#SEC410
// 1571 https://vice-emu.sourceforge.io/vice_17.html#SEC416
// 1581 https://vice-emu.sourceforge.io/vice_17.html#SEC419
...
public final class Disk
{
    ...
    public Disk(String fileName, String name, String id, String driveType, List<DiskImageLogic.TrackInfo> trackInfos, int maxDirectoryEntries)
    {
    ...
    public void formatDisk1581()
    {
        ...
        markTrackSector1581(40,0,true);     // Disk Header
        markTrackSector1581(40,1,true);     // BAM Side 1
        markTrackSector1581(40,2,true);     // BAM SIde 2
        markTrackSector1581(40,3,true);     // Director
    }
    ...
    public void markTrackSector1581(int track, int sector, boolean isUsed)
    {
